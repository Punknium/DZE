...
[nil,nil,rTitleText,"Redneck bandits have disabled an armed vehicle with lots of chain gun ammo in the gear! Check your map for the location!", "PLAIN",10] call RE;
...
if (_playerPresent) then {
	...
	[nil,nil,rTitleText,"Redneck survivors have secured the armed vehicle!", "PLAIN",10] call RE;
} else {
	...
	[nil,nil,rTitleText,"Redneck survivors did not secure the armed vehicle in time!", "PLAIN",10] call RE;
};
