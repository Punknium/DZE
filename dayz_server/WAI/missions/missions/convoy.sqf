...
[nil,nil,rTitleText,"A Home Depot delivery has been hijacked by redneck bandits, take over the convoy and the building supplies are yours!", "PLAIN",10] call RE;
...
if (_playerPresent) then {
	...
	[nil,nil,rTitleText,"Redneck survivors have secured the building supplies!", "PLAIN",10] call RE;
} else {
	...
	[nil,nil,rTitleText,"Redneck survivors did not secure the convoy in time!", "PLAIN",10] call RE;
};
