...
_box2 = createVehicle ["USBasicWeaponsBox",[(_position select 0) + 10,(_position select 1) + 10,0], [], 0, "CAN_COLLIDE"];
[_box2] call Small_Medical_Supply_Box;

_box3 = createVehicle ["USBasicWeaponsBox",[(_position select 0) + 10,(_position select 1) - 10,0], [], 0, "CAN_COLLIDE"];
[_box3] call Small_Food_Supply_Box;
...
[nil,nil,rTitleText,"Redneck bandits have obtained a weapon crate! Check your map for the location!", "PLAIN",10] call RE;
