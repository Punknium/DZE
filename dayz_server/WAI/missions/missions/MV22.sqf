...
"RU_Doctor",						  //Skin "" for random or classname here.
...
[nil,nil,rTitleText,"Redneck bandits have captured a Red Cross MV-22! An informant has advised there is medical supplies, he has updated the map for the location!", "PLAIN",10] call RE;
...
if (_playerPresent) then {
	...
	[nil,nil,rTitleText,"Redneck survivors have secured the MV-22!", "PLAIN",10] call RE;
} else {
	...
	[nil,nil,rTitleText,"Redneck survivors did not secure the MV-22 in time!", "PLAIN",10] call RE;
};
