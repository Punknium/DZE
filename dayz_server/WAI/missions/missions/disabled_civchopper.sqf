...
[nil,nil,rTitleText,"A group of redneck farmers have just purchased a helicopter! Go see if you can make it yours...", "PLAIN",10] call RE;
...
if (_playerPresent) then {
	...
	[nil,nil,rTitleText,"Redneck survivors have stolen the chopper!", "PLAIN",10] call RE;
} else {
	...
	[nil,nil,rTitleText,"Redneck survivors did not secure the Civilian Aircraft in time!", "PLAIN",10] call RE;
};
