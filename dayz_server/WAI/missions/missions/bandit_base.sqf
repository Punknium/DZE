...
_veh = createVehicle [_vehclass,[(_position select 0) - 40,(_position select 1) + 40,0], [], 0, "CAN_COLLIDE"];
_vehdir = 0;
_veh setDir _vehdir;
...
[nil,nil,rTitleText,"A redneck task force have set up a temporary encampment! Go and ambush it to make it yours!!", "PLAIN",10] call RE;
...
[nil,nil,rTitleText,"Redneck survivors captured the base, HOORA!!", "PLAIN",10] call RE;
} else {
...
[nil,nil,rTitleText,"The redneck survivors were unable to capture the base time is up!", "PLAIN",10] call RE;
};
