...
// get first rbg + m
_NV1 = player getvariable ["NV1",[1.2,1.2,1.2,0]];
_NV2 = player getvariable ["NV2",[1.5,1.5,1.5,-0.3]];
_NV3 = player getvariable ["NV3",[0.3,0.3,0.3,0.6]];
...
if(_NVOn == "ON") exitwith
{
	...
	s_pz_player1 = player addAction [localize "STR_EPOCH_ACTIONS_NIGHTVIS", "custom\vision.sqf", [], 0, false, true, "", "_this == _target"];
};
...
s_pz_player2 = player addAction [localize "STR_EPOCH_ACTIONS_NIGHTVIS", "custom\vision.sqf", [], 0, false, true, "", ""];
