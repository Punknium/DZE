...
_requirements = [];
switch true do {
	case (_count <= 25):  {_requirements = [["ItemGoldBar10oz",1]]};
	case (_count <= 50):  {_requirements = [["ItemGoldBar10oz",2]]};
	case (_count <= 75):  {_requirements = [["ItemGoldBar10oz",3]]};
	case (_count <= 100): {_requirements = [["ItemGoldBar10oz",4]]};
	case (_count <= 125): {_requirements = [["ItemGoldBar10oz",5]]};
	case (_count <= 150): {_requirements = [["ItemGoldBar10oz",6]]};
	case (_count <= 175): {_requirements = [["ItemGoldBar10oz",7]]};
	case (_count <= 200): {_requirements = [["ItemGoldBar10oz",8]]};
	case (_count <= 225): {_requirements = [["ItemGoldBar10oz",9]]};
	case (_count <= 250): {_requirements = [["ItemBriefcase100oz",1]]};
	case (_count <= 500): {_requirements = [["ItemBriefcase100oz",2]]};
	case (_count <= 750): {_requirements = [["ItemBriefcase100oz",3]]};
	case (_count >  750): {_requirements = [["ItemBriefcase100oz",4]]};
};
