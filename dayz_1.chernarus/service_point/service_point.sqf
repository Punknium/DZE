...
_servicePointClasses = dayz_fuelpumparray + DZE_fueltruckarray + ["C130J"]; // service point classes (can be house, vehicle and unit classes)
...
_refuel_amount = 0.025; // amount of fuel to add with every update (in percent)
